...
/*
 * This code has been copied from the libdevmapper component of LVM2.  I
 * don't want a dependency on libdevmapper just for a datastructure.
 */
 ...
 */
#define list_head(v, t, e) dm_struct_field(v, t, e, list)
